...
const Requests = () => {
    ...
    if (!requests) return;
    if (requests.length === 0) return <h1 className="flex justify-center font-bold text-3xl">No Request Found</h1>
        ...
        <div className="text-center my-10">
            <h1 className="font-bold text-3xl">Connection Requests</h1>
            {
                requests.map((request) => {
                    ...
                    return <div className="m-4 p-4 rounded-lg bg-base-200 flex w-2/3 mx-auto" key={_id}>
